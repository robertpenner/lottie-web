// Compositor-Safe Lottie Profile (CSLP) worker player. Same wiring as the
// no-modifiers worker entry, but the build that consumes this entry also
// aliases away text/image elements and the font manager (see the `cslp` build
// flag in rollup.config.js). The result renders the CSLP subset only —
